...
FIELD_PRIORITY = {
    ...
    "jeonse_right_flag": ["registry_ocr", "manual_correction", "user_checklist"],
    "leasehold_registration_flag": ["registry_ocr", "manual_correction", "user_checklist"],
    "ownership_transfer_recent_flag": ["registry_ocr", "manual_correction", "user_checklist"],
    "registry_warning_flag": ["registry_ocr", "manual_correction", "user_checklist"],
